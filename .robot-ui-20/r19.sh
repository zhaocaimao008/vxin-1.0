...
echo "# R19 报告" > "$OUT"
echo "" >> "$OUT"
echo "负责文件: components/EmojiPicker.jsx components/ReconnectingBanner.jsx components/GroupCallModal.jsx" >> "$OUT"
echo "" >> "$OUT"
for rel in components/EmojiPicker.jsx components/ReconnectingBanner.jsx components/GroupCallModal.jsx; do
  f="$SRC/$rel"
