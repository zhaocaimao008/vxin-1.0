...
crashReporter.start({
  ...
  companyName: 'Vxin',
  submitURL: 'https://vxinchat.com/api/crash-report',
...
const UPDATE_FEED_FALLBACK = 'https://vxinchat.com/downloads/updates';
...
let API_ORIGIN = (() => {
  try { return new URL(SERVER_URL).origin; } catch { return 'https://vxinchat.com'; }
})();
