      ...
      <div className="wc-modal wide" style={{ width: 480, height: 560 }}>
        ...
        {done ? (
          ...
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: 40, gap: 16 }}>
            <div style={{ width: 60, height: 60, background: '#07C160', borderRadius: 30, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 28 }}>✓</div>
            <div style={{ fontSize: 16, fontWeight: 500, color: '#191919' }}>已发送给 {sentCount} 位联系人</div>
            <button className="wc-modal-btn primary" style={{ width: 120, marginTop: 8 }} onClick={onClose}>完成</button>
          </div>
        ) : (
          <>
            {/* 消息预览 */}
            ...
            <div style={{ flex: 1, overflowY: 'auto' }}>
              ...
              {tab === 'groups' && filteredGroups.map(g => (
                <div key={g.id} style={{ display: 'flex', alignItems: 'center', padding: '8px 16px', gap: 10, cursor: 'pointer', borderBottom: '1px solid #F5F5F5', transition: 'background .08s' }}
                  ...
                  <GroupAvatar members={g.members || []} size={38} />
