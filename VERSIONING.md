...
| Web 前端 | `web/package.json` | `version` | 2.0.4 |
| 后端 | `backend-v2/package.json` | `version` | 2.0.0 |
| Android | `android/app/build.gradle.kts` | `versionName` / `versionCode` | 1.0.21 / code 22 |
| iOS | `ios/project.yml` | `MARKETING_VERSION` | 1.0.13 |
